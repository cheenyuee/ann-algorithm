 ...
 * R ：point 的最大出度
 * M = R / 2
 * efConstruction ：构图时的候选队列大小，efConstruction = L
 */
...
#pragma omp parallel for
    ...
    for (int i = 0; i < nb; ++i) {
      ...
      if (level > 0) { // 记录第 i 个点多个 level 的邻居
